...
class ipCity {
    ...
    public function getCity( $userip, $dat_path = '' ) {
        ...
        empty( $dat_path ) && $dat_path = $_SERVER['DOCUMENT_ROOT'] . '/static/qqwry.dat';
        //判断IP地址是否有效
        ...
        // $useripaddr = "$useripAddr1 $useripAddr2";// 江苏省常州市 电信
        $useripaddr = $useripAddr1;
        // echo "#".iconv( 'GBK', 'UTF-8', $useripAddr1 )."#".iconv( 'GBK', 'UTF-8', $useripAddr2 );
